...
class Blogs extends CI_Controller
{
	...
	public function index($offset = 0)
	{
		...
		$this->load->view('header',array('title'=>'Welcome to Kedium 1.0'));
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			//upload image
			$config['upload_path'] 		= $cwd."\\application\\assets\\images\\blogs\\";
           //$config['upload_path']      = base_url('/application/assets/images/blogs/');
           // $config['upload_path'] = base_url('./images/blogs');
